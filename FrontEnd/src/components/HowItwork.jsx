...
function HowItWork() {
  return (
    <div className="container mx-auto px-4 py-8">
      <Heading size="2" className="text-center mb-8 text-gray-900 dark:text-gray-100">How Read for Speed Works?</Heading>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        {/* Right side */}
        <div>
          <Text as="p" className="mb-4 text-gray-700 dark:text-gray-300">
